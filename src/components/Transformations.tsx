...
const professorCases: ICase[] = [
  {
    ...
    beforeTag: 'Antes',
    afterTag: 'Atual',
    before: '/assets/resultado-1.webp',
    after: '/assets/resultado-2.webp',
    stats: [
  ...
  },
  {
    ...
    beforeTag: 'Antes',
    afterTag: 'Depois',
    before: '/assets/resultado-3.webp',
    after: '/assets/plano-presencial.webp',
    stats: [
...
const alunosCases: ICase[] = [
  {
    ...
    beforeTag: 'Início',
    afterTag: 'Atual',
    before: '/assets/plano-anual.webp',
    after: '/assets/extra.webp',
    stats: [
  ...
  },
  {
    ...
    beforeTag: 'Antes',
    afterTag: 'Depois',
    before: '/assets/plano-online.webp',
    after: '/assets/resultado-1.webp',
    stats: [
  ...
  },
  {
    ...
    beforeTag: 'Início',
    afterTag: 'Atual',
    before: '/assets/resultado-2.webp',
    after: '/assets/resultado-3.webp',
    stats: [
